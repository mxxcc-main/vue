    ...
    <div v-if="phoneSize" class="block-container-phone">
      ...
      <div class="detail-item-container">
        ...
        <div style="margin-top: 10px;width: 94%;display: flex;flex-direction: column;">
          <div>
            <div class="block-item-title">{{$t('home.headerMenu.miner')}}：<span style="font-size: 12px;color:#666666;max-width: calc(100vw * 0.61); text-overflow: ellipsis;overflow: hidden;display: inline-block;" >{{records.miner}}</span> </div>
          </div>
          <div>
          ...
          <div>
            <div class="block-item-title">{{$t('common.transaction')}}：<span style="font-size: 12px;color: #666666;max-width: calc(100vw * 0.61); text-overflow: ellipsis;overflow: hidden;display: inline-block;">{{records.timestamp}}</span> </div>
          </div>
          <!--<div>-->
          ...
          <!--</div>-->
          <div>
            <div class="block-item-title">{{$t('common.gameLimit')}}：<span style="font-size: 12px;color:#666666;max-width: calc(100vw * 0.61); text-overflow: ellipsis;overflow: hidden;display: inline-block;">{{records.gasLimit}}</span> </div>
          </div>
          <div>
            <div class="block-item-title">{{$t('common.gasUsed')}}：<span style="font-size: 12px;color:#666666;max-width: calc(100vw * 0.61); text-overflow: ellipsis;overflow: hidden;display: inline-block;">{{records.gasUsed}}</span> </div>
          </div>
          <div>
            <div class="block-item-title">{{$t('common.blockReward')}}：<span style="font-size: 12px;color:#666666;max-width: calc(100vw * 0.61); text-overflow: ellipsis;overflow: hidden;display: inline-block;">{{records.timestamp}}</span> </div>
          </div>
